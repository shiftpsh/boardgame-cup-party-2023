"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[5697],{9117:function(e,t,i){i.d(t,{V:function(){return eH},b:function(){return e3},c:function(){return tI},o:function(){return t2},q:function(){return eQ}});var r,n=i(7365),s=i(5543),a=i(9365),o=i(803),l=i(8341);function u(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",u()),h=new o.Yd("@firebase/auth");function d(e,...t){h.logLevel<=o.in.ERROR&&h.error(`Auth (${s.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eY(e,t,i=!1){let r="signIn",n=await eJ(e,r,t),s=await eK._fromIdTokenResponse(e,r,n);return i||await e._updateCurrentUser(s.user),s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function eQ(e,t){return(0,n.m9)(e).setPersistence(t)}new WeakMap;let eZ="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
